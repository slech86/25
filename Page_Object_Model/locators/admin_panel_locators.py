...
class AdminResumeEditPageLocators():
    ...
    FIELD_JOB_SEARCH_STATUS = (By.XPATH, ('//span[contains(@id, "select2-resume-job_search_status-")]'))

    FIELD_NAME_COURSE_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(1) [name="Courses[0][name_certificate]"]'))
    FIELD_COURSE_PERIOD_START_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(1) [name="Courses[0][training_period_start]"]'))
    FIELD_COURSE_PERIOD_FINISH_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(1) [name="Courses[0][training_period_finish]"]'))
    IFRAME_CKEDITOR_COURSE_DESCRIPTION_1 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][1]//div[contains(@id, "cke_courses-0-description")]//iframe'))

    FIELD_NAME_COURSE_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(1) [name="Courses[1][name_certificate]"]'))
    FIELD_COURSE_PERIOD_START_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(1) [name="Courses[1][training_period_start]"]'))
    FIELD_COURSE_PERIOD_FINISH_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(1) [name="Courses[1][training_period_finish]"]'))
    IFRAME_CKEDITOR_COURSE_DESCRIPTION_2 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][1]//div[contains(@id, "cke_courses-1-description")]//iframe'))

    FIELD_NAME_OF_INSTITUTION_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[0][name_institution]"]'))
    FIELD_LEVEL_OF_EDUCATION_1 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][2]//span[contains(@id, "select2-educations-0-level_education-")]'))
    FIELD_COUNTRY_EDUCATION_1 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][2]//span[contains(@id, "select2-education-0-country_")]'))
    FIELD_CITY_EDUCATION_1 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][2]//span[@id="select2-education-0-city_id-container"]'))
    FIELD_DEPARTMENT_AND_SPECIALITY_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[0][specialty]"]'))
    FIELD_EDUCATION_PERIOD_START_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[0][date_start]"]'))
    FIELD_EDUCATION_PERIOD_FINISH_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[0][date_finish]"]'))

    FIELD_NAME_OF_INSTITUTION_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[1][name_institution]"]'))
    FIELD_LEVEL_OF_EDUCATION_2 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][2]//span[contains(@id, "select2-educations-1-level_education-")]'))
    FIELD_COUNTRY_EDUCATION_2 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][2]//span[contains(@id, "select2-education-1-country_")]'))
    FIELD_CITY_EDUCATION_2 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][2]//span[@id="select2-education-1-city_id-container"]'))
    FIELD_DEPARTMENT_AND_SPECIALITY_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[1][specialty]"]'))
    FIELD_EDUCATION_PERIOD_START_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[1][date_start]"]'))
    FIELD_EDUCATION_PERIOD_FINISH_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(2) [name="Educations[1][date_finish]"]'))

    FIELD_COMPANY_NAME_RESUME_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[0][company]"]'))
    FIELD_COMPANY_SITE_RESUME_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[0][web_site]"]'))
    FIELD_SCOPE_OF_COMPANY_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[0][category][]"] + span .select2-selection__choice'))
    FIELD_POSITION_RESUME_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[0][position]"]'))
    FIELD_WORK_PERIOD_START_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[0][period_employment_start]"]'))
    FIELD_WORK_PERIOD_FINISH_1 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[0][period_employment_finish]"]'))
    IFRAME_CKEDITOR_RESPONSIBILITIES_AND_ACHIEVEMENTS_1 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][3]//div[contains(@id, "cke_experiences-0-responsibilities")]//iframe'))

    FIELD_COMPANY_NAME_RESUME_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[1][company]"]'))
    FIELD_COMPANY_SITE_RESUME_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[1][web_site]"]'))
    FIELD_SCOPE_OF_COMPANY_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[1][category][]"] + span .select2-selection__choice'))
    FIELD_POSITION_RESUME_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[1][position]"]'))
    FIELD_WORK_PERIOD_START_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) [name="Experiences[1][period_employment_start]"]'))
    CHECKBOX_WORK_PERIOD_FINISH_2 = (By.CSS_SELECTOR, ('#tab-1 > .panel.panel-default:nth-child(3) .switch[name="Experiences[1][untilNow]"]'))  # "По насоящее время"
    IFRAME_CKEDITOR_RESPONSIBILITIES_AND_ACHIEVEMENTS_2 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][3]//div[contains(@id, "cke_experiences-1-responsibilities")]//iframe'))

    FIELD_LANGUAGE_RESUME_1 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][4]//span[contains(@id, "select2-knowledgeoflanguages-0-language-")]'))
    FIELD_LEVEL_LANGUAGE_RESUME_1 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][4]//span[contains(@id, "select2-knowledgeoflanguages-0-level-")]'))

    FIELD_LANGUAGE_RESUME_2 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][4]//span[contains(@id, "select2-knowledgeoflanguages-1-language-")]'))
    FIELD_LEVEL_LANGUAGE_RESUME_2 = (By.XPATH, ('//div[@id="tab-1"]/div[@class="panel panel-default"][4]//span[contains(@id, "select2-knowledgeoflanguages-1-level-")]'))
    ...
    FIELD_PHONE_1 = (By.CSS_SELECTOR, ('#resume-descriptions-1-phone-0'))
    FIELD_PHONE_2 = (By.CSS_SELECTOR, ('#resume-descriptions-1-phone-1'))
