...
#     input_prefix = 'resumeeditform-'
    ...
    # FIELD_JOB_TITLE = (By.CSS_SELECTOR, ('#' + input_prefix + 'job_title'))
    # CATEGORY_RESUME_SALES_CUSTOMER_MANAGEMENT = "document.getElementsByName('ResumeEditForm[category_id][]')[13].click()"
    # SUBCATEGORIES_ACCOUNT_MANAGER = (By.CSS_SELECTOR, ('[for="subcategories_id-168"]'))
    # UNDEREMPLOYMENT = (By.CSS_SELECTOR, ('#' + input_prefix + 'employment > .checkbox:nth-child(2) > label'))  # Неполная занятость
    # SALARY = (By.CSS_SELECTOR, ('#' + input_prefix + 'salary'))
    # DROPDOWN_CURRENCY = (By.CSS_SELECTOR, ('[data-id="' + input_prefix + 'currency"]'))
    # CURRENCY_USD = (By.CSS_SELECTOR, ('.field-' + input_prefix + 'currency [data-original-index="2"]'))
    ...
    # YEAR_WORK_EXPERIENCE_START_2010 = (By.XPATH, ('//div[@id="work-experience"]//div[contains(@class, "additional-block-item")][1]//form[contains(@id, "work-experience-form")]/div[5]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[14]/a'))
    ...
    # YEAR_WORK_EXPERIENCE_FINISH_2012 = (By.XPATH, ('//div[@id="work-experience"]//div[contains(@class, "additional-block-item")][1]//form[contains(@id, "work-experience-form")]/div[5]//div[@class="d-flex"]/div[contains(@class, "search-select")][2]//li[12]/a'))
    ...
    # YEAR_WORK_EXPERIENCE_START_1993_2 = (By.XPATH, ('//div[@id="work-experience"]//div[contains(@class, "additional-block-item")][2]//form[contains(@id, "work-experience-form")]/div[5]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[31]/a'))
    ...
    # DROPDOWN_YEAR_WORK_EXPERIENCE_FINISH_2 = (By.XPATH, ('//div[@id="work-experience"]//div[contains(@class, "additional-block-item")][2]//form[contains(@id, "work-experience-form")]/div[5]//div[@class="d-flex"]/div[contains(@class, "search-select")][2]//button'))
    # YEAR_WORK_EXPERIENCE_FINISH_1996_2 = (By.XPATH, ('//div[@id="work-experience"]//div[contains(@class, "additional-block-item")][2]//form[contains(@id, "work-experience-form")]/div[5]//div[@class="d-flex"]/div[contains(@class, "search-select")][2]//li[28]/a'))
    ...
    # YEAR_WORK_EXPERIENCE_START_2003_3 = (By.XPATH, ('//div[@id="work-experience"]//div[contains(@class, "additional-block-item")][3]//form[contains(@id, "work-experience-form")]/div[5]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[21]/a'))
    ...
    # INCOMPLETE_HIGHER_EDUCATION = (By.XPATH, ('//div[@id="education"]//div[contains(@class, "additional-block-item")][1]//form[contains(@id, "education-form")]/div[2]//li[3]/a'))
    ...
    # YEAR_EDUCATION_START_2005_2 = (By.XPATH, ('//div[@id="education"]//div[contains(@class, "additional-block-item")][2]//form[contains(@id, "education-form")]/div[6]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[19]/a'))
    ...
    # YEAR_EDUCATION_FINISH_2008_2 = (By.XPATH, ('//div[@id="education"]//div[contains(@class, "additional-block-item")][2]//form[contains(@id, "education-form")]/div[6]//div[@class="d-flex"]/div[contains(@class, "search-select")][2]//li[16]/a'))
    ...
    # YEAR_EDUCATION_START_2020_3 = (By.XPATH, ('//div[@id="education"]//div[contains(@class, "additional-block-item")][3]//form[contains(@id, "education-form")]/div[6]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[4]/a'))
    ...
    # YEAR_COURSES_START_2016 = (By.XPATH, ('//div[@id="courses-and-certificates"]//div[contains(@class, "additional-block-item")][1]//form[contains(@id, "course-form")]/div[2]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[8]/a'))
    ...
    # YEAR_COURSES_FINISH_2016 = (By.XPATH, ('//div[@id="courses-and-certificates"]//div[contains(@class, "additional-block-item")][1]//form[contains(@id, "course-form")]/div[2]//div[@class="d-flex"]/div[contains(@class, "search-select")][2]//li[8]/a'))
    ...
    # YEAR_COURSES_START_2020_2 = (By.XPATH, ('//div[@id="courses-and-certificates"]//div[contains(@class, "additional-block-item")][2]//form[contains(@id, "course-form")]/div[2]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[4]/a'))
    ...
    # YEAR_COURSES_FINISH_2021_2 = (By.XPATH, ('//div[@id="courses-and-certificates"]//div[contains(@class, "additional-block-item")][2]//form[contains(@id, "course-form")]/div[2]//div[@class="d-flex"]/div[contains(@class, "search-select")][2]//li[3]/a'))
    ...
    # YEAR_COURSES_START_2017_3 = (By.XPATH, ('//div[@id="courses-and-certificates"]//div[contains(@class, "additional-block-item")][3]//form[contains(@id, "course-form")]/div[2]//div[@class="d-flex width"]/div[contains(@class, "search-select")][2]//li[7]/a'))
    ...
    # YEAR_COURSES_FINISH_2018_3 = (By.XPATH, ('//div[@id="courses-and-certificates"]//div[contains(@class, "additional-block-item")][3]//form[contains(@id, "course-form")]/div[2]//div[@class="d-flex"]/div[contains(@class, "search-select")][2]//li[6]/a'))
    #
