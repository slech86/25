...
class TestData:
    ...
    date_of_company_foundation = '2020-12-31'   # не используется при заполнении полей, только при проверке заполнения полей в админке
    birthday = '2000-11-30'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    ...
    birthday_resume = '1982-09-05'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    ...
    job_title_resume_preview = 'test_job_title_resume_preview ' + time_Now
    ...
    work_period_start = '01.08.2019'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    work_period_finish = '01.03.2021'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    ...
    work_period_start_2 = '01.04.2021'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    ...
    education_period_start = '01.09.2011'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    education_period_finish = '01.05.2016'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    ...
    education_period_start_2 = '01.11.2019'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    education_period_finish_2 = '01.01.2021'  # не используется при заполнении полей, только при проверке заполнения полей в админке

    name_course = 'name_course_' + time_Now
    course_period_start = '01.06.2021'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    course_period_finish = '01.06.2022'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    course_description = 'course_description_' + time_Now

    name_course_2 = 'name_course_2_' + time_Now
    course_period_start_2 = '01.10.2015'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    course_period_finish_2 = '01.10.2016'  # не используется при заполнении полей, только при проверке заполнения полей в админке
...
class TestDataEditing:
    ...
    date_of_company_foundation = '1992-03-17'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    birthday = '2002-01-01'  # не используется при заполнении полей, только при проверке заполнения полей в админке
    ...
    birthday_resume = '1977-03-08'  # не используется при заполнении полей, только при проверке заполнения полей в админке
