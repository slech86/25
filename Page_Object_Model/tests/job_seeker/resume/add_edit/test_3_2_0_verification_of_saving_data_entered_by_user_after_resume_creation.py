...
def test_verification_of_saving_data_entered_by_user_after_resume_creation(browser, language):  # проверка сохранения введенных пользователем данных после создания резюме
    ...
    admin_resume_edit_page.verification_of_saving_data_entered_by_user_after_resume_creation_ru(exchange_rates[1], _resources_resume.user_resume)  # проверка сохранения введенных пользователем данных после создания резюме RU
